/* ============================================================================
   AUTHENTICATION MODULE - CJC Namespace Version
   ============================================================================ */

CJC.defineModule('auth', function() {
    'use strict';
    ...
    // Click outside handler - attached in initialize
    ...
    function initialize() {
        ...
        console.log('✅ Auth module loaded in CJC namespace');
    }
...
(function() {
    ...
    function setupCompatibility() {
        if (CJC && CJC.modules && CJC.modules.auth) {
            // Create global reference
            window.auth = CJC.modules.auth;
            
            // Also expose commonly used functions globally for backward compatibility
            window.initializeAuth = CJC.modules.auth.initialize;
            window.handleLogin = CJC.modules.auth.login;
            window.handleSignup = CJC.modules.auth.signup;
            window.logout = CJC.modules.auth.logout;
            window.showAuthModal = CJC.modules.auth.showAuthModal;
            window.hideAuthModal = CJC.modules.auth.hideAuthModal;
            window.toggleUserDropdown = CJC.modules.auth.toggleUserDropdown;
            window.hideUserDropdown = CJC.modules.auth.hideUserDropdown;
            window.showDemoLogin = CJC.modules.auth.showDemoLogin;
            
            console.log('✅ Auth compatibility layer established');
        } else {
            // Retry in a moment
